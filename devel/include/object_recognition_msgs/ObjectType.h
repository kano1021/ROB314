...
struct ObjectType_
{
  ...
  _key_type key;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _db_type;
  _db_type db;
...
struct Printer< ::object_recognition_msgs::ObjectType_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::object_recognition_msgs::ObjectType_<ContainerAllocator>& v)
  {
    ...
    s << indent << "db: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.db);
  }
};
