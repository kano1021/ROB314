...
struct TableArray_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::object_recognition_msgs::Table_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::object_recognition_msgs::Table_<ContainerAllocator> >> _tables_type;
  _tables_type tables;
